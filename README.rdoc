...
** Please, please don't use this repo. I've only cloned it because of some legacy code that needs Authlogic on Rails 4 and need to make sure it exists (for now).
